...
if ( ! class_exists( 'Jet_Woo_Product_Gallery_Settings' ) ) {
	...
	class Jet_Woo_Product_Gallery_Settings {
		...
		public function get_localize_data() {
			...
			foreach ( glob( jet_woo_product_gallery()->plugin_path( 'includes/components/elementor-views/widgets/' ) . '*.php' ) as $file ) {
				$data = get_file_data( $file, [ 'class' => 'Class', 'name' => 'Name', 'slug' => 'Slug' ] );
			...
			return array(
				...
				'settingsApiUrl' => '/jet-woo-product-gallery-api/v1/plugin-settings',
				'settingsData'   => array(
					'product_gallery_available_widgets' => array(
