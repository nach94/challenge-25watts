...
class Jet_Blocks_Woo_Cart extends Jet_Blocks_Base {
	...
	protected function register_controls() {
		...
		$this->__start_controls_tabs( 'tabs_view_product_remove_bnt_style' );

		$this->__start_controls_tab(
			'tab_view_product_remove_bnt_normal',
			array(
				'label' => esc_html__( 'Normal', 'jet-blocks' ),
			)
		);
		...
		$this->__add_control(
			'cart_product_remove_bnt_background_color',
			array(
				'label' => esc_html__( 'Background Color', 'jet-blocks' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['cart_product_remove'] => 'background-color: {{VALUE}} !important',
				),
			),
			25
		);
		...
		$this->__start_controls_tab(
			'tab_view_product_remove_bnt_hover',
			array(
				'label' => esc_html__( 'Hover', 'jet-blocks' ),
			)
		);
		...
		$this->__add_control(
			'cart_product_remove_bnt_hover_background_color',
			array(
				'label' => esc_html__( 'Background Color', 'jet-blocks' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['cart_product_remove'] . ':hover' => 'background-color: {{VALUE}} !important',
				),
			),
			25
		);
